...
INSERT INTO ski (nom_ski, prix_ski, largeur_ski, conseil_utilisation, stock, id_longueur, id_type_ski, id_fournisseur, id_marque, photo_ski) VALUES
('Experience 80', 399.99, 80, 'Parfait pour les skieurs intermédiaires', 5, 1, 1, 1, 1, 'static/images/experience-80.jpg'),
('QST 92', 549.99, 92, 'Idéal pour le tout-terrain', 3, 2, 2, 2, 2, 'static/images/qst-92.jpg'),
('Redster X9', 699.99, 75, 'Pour la compétition et le ski sportif', 2, 3, 4, 3, 3, 'static/images/redster-x9.jpg'),
('M-Pro 99', 799.99, 99, 'Ski polyvalent freeride, excellent en poudreuse', 4, 2, 8, 1, 5, 'static/images/m-pro-99.jpg'),
('Legend X96', 749.99, 96, 'Pour les skieurs experts cherchant de la performance en tout-terrain', 6, 3, 2, 2, 5, 'static/images/legend-x96.jpg'),
('M-Free 108', 849.99, 108, 'Ski freeride pour la poudreuse profonde', 3, 4, 8, 3, 5, 'static/images/m-free-108.jpg'),
('Speed Zone 4x4 82', 599.99, 82, 'Ski all-mountain performant sur piste', 7, 2, 2, 1, 5, 'static/images/speed-zone-4x4-82.jpg'),
('Mantra V.Werks', 999.99, 96, 'Ski haut de gamme pour skieur technique', 2, 3, 2, 2, 7, 'static/images/mantra-vwerks.jpg'),
('Mindbender 99Ti', 729.99, 99, 'Excellent en conditions variables', 5, 3, 2, 3, 6, 'static/images/mindbender-99ti.jpg'),
('Stance 96', 649.99, 96, 'Polyvalent pour tous types de neige', 8, 2, 2, 1, 2, 'static/images/stance-96.jpg'),
('Race Tiger SL', 899.99, 68, 'Ski de slalom pour compétiteur', 4, 2, 4, 1, 7, 'static/images/race-tiger-sl.jpg'),
...
('Wayback 98', 779.99, 98, 'All mountain pour skieur expert', 3, 3, 2, 3, 6, 'static/images/wayback-98.jpg'),
('Enforcer 94', 749.99, 94, 'All mountain performant', 6, 2, 2, 1, 8, 'static/images/enforcer-94.jpg'),
('Kore 93', 699.99, 93, 'All mountain léger', 4, 3, 2, 2, 4, 'static/images/kore-93.jpg'),
('Soul Rider 87', 599.99, 87, 'Freestyle all mountain', 8, 2, 3, 3, 8, 'static/images/soul-rider-87.jpg'),
('MTN Explore 95', 829.99, 95, 'Randonnée haute performance', 3, 3, 6, 1, 2, 'static/images/mtn-explore-95.jpg'),
('V-Shape V10', 649.99, 85, 'Ski de piste sportif', 5, 2, 1, 2, 4, 'static/images/v-shape-v10.jpg'),
('Ripstick 96', 779.99, 96, 'All mountain freestyle', 4, 3, 2, 3, 9, 'static/images/ripstick-96.jpg');
